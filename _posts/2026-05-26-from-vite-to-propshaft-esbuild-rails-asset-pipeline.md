...
**Propshaft doesn't care how your assets are built.** It fingerprints files and serves them. This means you can swap the builder (esbuild → importmaps) without touching the server.
